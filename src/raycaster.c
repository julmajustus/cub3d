...
/*   Updated: 2024/11/02 23:06:45 by skwon2           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void render_wall_column(t_caster *c, int x)
{
	...
	while (y <= c->draw_end)
	{
		...
		c->pixel_color = (c->wall_texture->pixels[tex_index] << 24) | (c->wall_texture->pixels[tex_index + 1] << 16) | (c->wall_texture->pixels[tex_index + 2] << 8) | c->wall_texture->pixels[tex_index + 3];
